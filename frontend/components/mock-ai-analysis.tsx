...
interface MockAIAnalysisProps {
  product: any
  ean: string
}

// This is a version of the AI Analysis component that uses the mock API endpoint
// Use this if you're having issues with the Gemini API
export function MockAIAnalysis({ product, ean }: MockAIAnalysisProps) {
      ...
      {!analysis && !loading && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Use our AI to analyze this product and get insights</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="mb-4">
      ...
      {loading && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Analyzing the product data...</CardDescription>
          </CardHeader>
          <CardContent>
